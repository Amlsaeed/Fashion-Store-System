...
namespace Fashion_Store_System.Controllers
{
    public class ProductSizesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name")] ProductSize productSize)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name")] ProductSize productSize)
        {
