...
namespace Fashion_Store_System.Controllers
{
    public class ProductColorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name")] ProductColor productColor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name")] ProductColor productColor)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    // 1. إضافة رسالة النجاح هنا
                    TempData["SuccessMessage"] = "تم تحديث بيانات اللون بنجاح!";
                }
                ...
                // 2. التوجيه لصفحة الجدول عشان الرسالة تظهر هناك
                return RedirectToAction(nameof(Index));
            }
            return View(productColor);
        }
